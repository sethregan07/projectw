      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold text-foreground mb-3">Shiftcivic</h3>
            <p className="text-muted-foreground leading-relaxed max-w-sm">
              Building network states for sustainable living. Join us in creating the future of decentralized governance and community.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/knowledge" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Knowledge
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-border/40">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Shiftcivic. All rights reserved.
            </p>
